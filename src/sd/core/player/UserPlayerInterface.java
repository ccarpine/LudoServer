...
public interface UserPlayerInterface extends Remote {
	 ...
	 */
	void updateStatus(final List<Partecipant> partecipants, final GameBoard gameBoard, final String ipCurrentPartecipant, boolean isDoubleTurn) throws RemoteException;
