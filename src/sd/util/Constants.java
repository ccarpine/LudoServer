...
public class Constants {
	...
	/**
	 * Number of rows in the matrix representing the game board (it coincides with the maximum number of allowed players)
	 */
	public static final int ROWS = 6;
	/**
	 * Number of columns in the matrix representing the game board cells for each player (7 blank cells, 1 colored forstart, 4 for victory)
	 */
	public static final int COLUMNS = 12;
	/**
	 * The possible colors of the pawns. This order coincides with the one in which the players will alternate their turns
	 */
	...
	/* The next 8 constants are "basic steps" to follow in order to build the grid for the GUI game board*/
